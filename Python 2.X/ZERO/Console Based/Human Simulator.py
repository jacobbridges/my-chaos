    ...
    while loop:
        try:
            ...
            if fast.lower() in accept:
                ...
                print 'The available commands are ' + str(accept)[1:-1] + ', ' + str(deny)[1:-1] + ', ' + str(notes_words)[1:-1] + '.'
            else:
...
while True:
    ...
    if prompt.lower() in start_words:
        ...
        print 'The available commands are ' + str(start_words)[1:-1] + ', ' + str(break_words)[1:-1] + ', ' + str(notes_words)[1:-1] + '.'
    else:
