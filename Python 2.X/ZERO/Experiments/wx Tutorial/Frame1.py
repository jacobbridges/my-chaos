...
class Frame1(wx.Frame):
    ...
    def _init_coll_menuHelp_Items(self, parent):
        ...
        parent.Append(help=u'Display general information about Notebook',
    ...
    def _init_coll_menuFile_Items(self, parent):
        ...
        parent.Append(help=u'Load a file', id=wxID_FRAME1MENUFILEOPEN,
              kind=wx.ITEM_NORMAL, text=u'Open')
        parent.Append(help=u'Record the text', id=wxID_FRAME1MENUFILESAVE,
              kind=wx.ITEM_NORMAL, text=u'Save')
        parent.Append(help=u'Store with filename', id=wxID_FRAME1MENUFILESAVEAS,
              kind=wx.ITEM_NORMAL, text=u'Save As')
        parent.Append(help=u'Remove the text', id=wxID_FRAME1MENUFILECLOSE,
              kind=wx.ITEM_NORMAL, text=u'Close')
        parent.Append(help=u'Quit this program', id=wxID_FRAME1MENUFILEEXIT,
    ...
    def _init_ctrls(self, prnt):
        ...
        wx.Frame.__init__(self, id=wxID_FRAME1, name='', parent=prnt,
              pos=wx.Point(516, 356), size=wx.Size(385, 334),
              style=wx.DEFAULT_FRAME_STYLE, title=u'Notebook')
        self._init_utils()
        self.SetClientSize(wx.Size(377, 300))
        ...
        self.textEditor = wx.TextCtrl(id=wxID_FRAME1TEXTEDITOR,
              ...
              size=wx.Size(377, 257), style=wx.TE_MULTILINE, value=u'')
